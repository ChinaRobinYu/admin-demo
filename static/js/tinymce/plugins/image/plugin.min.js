!(function () {
	...
	var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
		...
		h = typeof window !== 'undefined' ? window : Function('return this;')(),
		v = function (e, t) {
			return (function (e, t) {
				for (var n = t !== undefined && t !== null ? t : h, r = 0; r < e.length && n !== undefined && n !== null; ++r) n = n[e[r]]
				return n
			}(e.split('.'), t))
		},
		t = {
			getOrDie: function (e, t) {
				var n = v(e, t)
				if (n === undefined || n === null) throw e + ' not available on this browser'
				return n
			}
		}
	function b () {
	...
	var y, x = tinymce.util.Tools.resolve('tinymce.util.Promise'),
		...
		Z = function (e, t) {
			...
			setTimeout(function () {
				if (w) {
					var wi = document.querySelector('[aria-label="Width"]')
					if (wi) {
						wi.value = w
					}
				}
				// if (h) {
				// 	var hi = document.querySelector('[aria-label="Height"]')
				// 	if (wi) {
				// 		hi.value = h
				// 	}
				// }
		...
		ae = function (e) {
			...
			return n ? e.dom.select('img', n)[0] : t && (t.nodeName !== 'IMG' || t.getAttribute('data-mce-object') || t.getAttribute('data-mce-placeholder')) ? null : t
		},
		oe = function (t, e) {
			var n = t.dom,
		...
		le = function (t, e) {
			var n = (function (e, t) {
				...
				if (ne(e, E(t, {
					...
					r.appendChild(k.create('figcaption', {
						contentEditable: !0
					},
					'Caption')),
				...
				items: [{
					...
					function (e) {
						...
						if (i(o)) {
							...
							n.find('#vspace').value(''),
							n.find('#hspace').value(''),
							((a = R(a))['margin-top'] && a['margin-bottom'] || a['margin-right'] && a['margin-left']) && (a['margin-top'] === a['margin-bottom'] ? n.find('#vspace').value(A(a['margin-top'])) : n.find('#vspace').value(''), a['margin-right'] === a['margin-left'] ? n.find('#hspace').value(A(a['margin-right'])) : n.find('#hspace').value('')),
							a['border-width'] ? n.find('#border').value(A(a['border-width'])) : n.find('#border').value(''),
							a['border-style'] ? n.find('#borderStyle').value(a['border-style']) : n.find('#borderStyle').value(''),
		...
		ge = function (e, t) {
			setTimeout(function () {
				var tabs = document.querySelectorAll('.mce-tab')
				if (tabs.length === 2) {
		...
		me = function (e, t, n) {
			var r = e.state.get('oldVal'),
				...
				o = e.value(),
				i = t.value()
			n && r && a && o && i && (o !== r ? (i = Math.round(o / r * i), isNaN(i) || t.value(i)) : (o = Math.round(i / a * o), isNaN(o) || e.value(o))),
			de(e, t)
		},
		fe = function (e) {
			ge(e, me)
		...
		ye = function (s, e) {
			var t = [{
				...
				onchange: function (e) {
					...
					i.width || i.height || (r = n.convertURL(l.value(), 'src'), a = g(n), o = new RegExp('^(?:[a-z]+:)?//', 'i'), a && !o.test(r) && r.substring(0, a.length) !== a && (r = a + r), l.value(r), N(n.documentBaseURI.toAbsolute(l.value()),
						function (e) {
	...
	function Re (i) {
		var t = function (e, r, a, t) {
			var o, n; (o = new Ae()).open('POST', i.url),
			...
			o.onload = function () {
				var e, t, n
				o.status < 200 || o.status >= 300 ? a('HTTP Error: ' + o.status) : (e = JSON.parse(o.responseText)) && typeof e.location === 'string' ? r((t = i.basePath, n = e.location, t ? t.replace(/\/$/, '') + '/' + n.replace(/^\//, '') : n)) : a('Invalid JSON: ' + o.responseText)
			},
		...
		Me = function (o) {
			return function (e) {
				for (var t, n, r = e.length,
					...
					t = e[r],
					(n = t.attr('class')) && /\bimage\b/.test(n) && (t.attr('contenteditable', o ? 'false' : null), w.each(t.getAll('figcaption'), a))
				}
			}
		},
		De = function (e) {
